...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEM - Formulario banner</title>
...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li class="xn-openable active">
                ...
                <ul>
                    <li class="active"><a href="lbanner"><span class="fa fa-list"></span>Listado</a></li>
                </ul>
            </li>
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Formulario Banner inicio</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                                    ...
                                    <div class="wizard-step-1">
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <!-- begin col-6 -->
                                                <div class="col-md-12">
                                                    <h3 class="form-header form-header-lg m-b-10">Escriba la información del banner</h3>
                                                    <div class="height-xs">
                                                        <div class="form-group">
                                                            <label>Titulo del banner</label>
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                <input data-parsley-id="2967" name="titulo" id="titulo" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpbanner->title  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                ...
                                                <form action="../opimagenes/upload.php" id="frmdzone" class="dropzone">
                                                    ...
                                                    <input type="hidden" id="hdniw" name="iw[]" value="1600" />
                                                    <input type="hidden" id="hdnih" name="ih[]" value="564" />
                        ...
                        <div class="wizard-step-5 text-center">
                            ...
                            <p><a href="lbanner.php" class="btn btn-success btn-lg">Finalizar</a></p>
                        </div>
                        <!-- end wizard step-5 -->
                    </div>
                    <!-- end #wizard -->
...
<script type="application/x-javascript">
    ...
    var $contd;
    var $id_banner = <?php echo $id; ?>;
    jQuery(document).ready(function(){

        $('#hdnid_c').val($id_banner);
        // ** Dopzone  sortable **
        $contd = $("#divdzone");
        $contd.sortable({
            revert: 300,
        ...
        $("#wizard").bwizard({
            validating: function(e, a) {
                ...
                if ($('form[name="form-wizard"]').parsley().validate("wizard-step-1")) {
                    ...
                    if ($id_banner != 0) {
                        $.ajax({
                            data:  {'op':'Modificar', 'id':$id_banner, 'titulo':$('#titulo').val()},
                            url:   'opbanner.php',
                            type:  'post',
                            success:  function (response) {
                                //alert("Modif:\n\n"+response);
                        ...
                        $.ajax({
                            data:  {'op':'Agregar', 'titulo':$('#titulo').val()},
                            url:   'opbanner.php',
                            type:  'post',
                            success:  function (response) {
                                //alert("Insert:\n\n"+response);
