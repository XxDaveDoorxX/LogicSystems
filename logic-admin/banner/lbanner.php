...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEM - Listado banner</title>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Banner inicio</h2>
        </div>
        <!-- END PAGE TITLE -->
                                ...
                                <table id="customers2" class="table datatable table-actions table-striped">
                                    ...
                                    foreach ($banner as $e){
                                        ...
                                        <tr id="trow_<?php echo $e['id']; ?>">
                                            ...
                                            <td>
                                                <a href="fbanner.php?id=<?php echo $e['id']; ?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
