...
$tmpthumb = new Thumbs(0,'',$id);
$thumbs = $tmpthumb->listar_x_id_product();
...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEM - Listado thumbnail galeria </title>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Thumbsnail galería</a></li>
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Galería de thumbnails</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            if(empty($thumb)) {
                            ?>
                                <h3 class="panel-title">Agrega una nueva galería</h3>
                                <div class="btn-group pull-right">
                                    <a href="fthumbs?id_product=<?php echo $tmpproduct->id ?>"
                                       class="btn btn-danger"><i class="fa fa-bars"></i> Agregar Galeria</a>
                                </div>
                                <?php
                            }
                            ?>
                                ...
                                <table id="customers2" class="table datatable table-actions table-striped">
                                    ...
                                    foreach ($thumbs as $e){
                                        ...
                                        <tr id="trow_<?php echo $e['id']; ?>">
                                            ...
                                            <td>
                                                <a href="fthumbs?id=<?php echo $e['id']; ?>&id_product=<?php echo $tmpproduct->id ?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
