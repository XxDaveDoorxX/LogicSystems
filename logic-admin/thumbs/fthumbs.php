...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEM - Formulario thumbnail galeria </title>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Galería thumbnails</a></li>
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Formulario galería thumbnails</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3>Formulario galería thumbnails</h3>
                            <!-- begin form-wizard -->
                                                    ...
                                                    <div class="height-xs">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input data-parsley-id="2967" name="titulo" id="titulo" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpthumb->title  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                ...
                                                <form action="../opimagenes/upload.php" id="frmdzone" class="dropzone">
                                                    ...
                                                    <input type="hidden" id="hdniw" name="iw[]" value="165" />
                                                    <input type="hidden" id="hdnih" name="ih[]" value="100" />
...
<script type="application/x-javascript">
    ...
    var $contd;
    var $id_thumbs = <?php echo $id; ?>;
    jQuery(document).ready(function(){

        $('#hdnid_c').val($id_thumbs);
        // ** Dopzone  sortable **
        $contd = $("#divdzone");
        $contd.sortable({
            revert: 300,
        ...
        $("#wizard").bwizard({
            validating: function(e, a) {
                ...
                if ($('form[name="form-wizard"]').parsley().validate("wizard-step-1")) {
                    ...
                    //alert("id banner: "+$id_thumbs);
                    if ($id_thumbs != 0) {
                        $.ajax({
                            data:  {'op':'Modificar', 'id':$id_thumbs, 'titulo':$('#titulo').val(), 'id_product':$('#id_product').val()},
                            url:   'opthumbs.php',
                            type:  'post',
                            success:  function (response) {
                                //alert("Modif:\n\n"+response);
