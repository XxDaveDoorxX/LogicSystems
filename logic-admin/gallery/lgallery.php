...
$gallery = $tmpgallery->listar_x_id_product();
$galler = current($gallery);
...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEM - Listado galeria </title>
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Galería</h2>
        </div>
        <!-- END PAGE TITLE -->
                        ...
                        <div class="panel-heading">
                            ...
                            ?>
                                ...
                                <div class="btn-group pull-right">
                                    <a href="fgallery?id_product=<?php echo $tmpproduct->id ?>"
                                ...
                                <table id="customers2" class="table datatable table-actions table-striped">
                                    ...
                                    foreach ($gallery as $e){
                                        ...
                                        <tr id="trow_<?php echo $e['id']; ?>">
                                            ...
                                            <td>
                                                <a href="fgallery?id=<?php echo $e['id']; ?>&id_product=<?php echo $tmpproduct->id ?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
