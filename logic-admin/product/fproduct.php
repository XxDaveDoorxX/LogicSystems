...
<head>
    <!-- META SECTION -->
    <title>LOGIC SYSTEMS - Formulario Propiedades</title>
...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li class="xn-openable active">
                ...
                <ul>
                    <li><a href="lproduct"><span class="fa fa-list"></span>Listado</a></li>
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Formulario Productos</h2>
        </div>
        <!-- END PAGE TITLE -->
                                    ...
                                    <div class="wizard-step-1">
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <!-- begin col-6 -->
                                                <div class="col-md-12">
                                                    <h3 class="form-header form-header-lg m-b-10">Escriba la información del producto</h3>
                                                    <div class="height-xs">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input data-parsley-id="2967" name="nombre" id="nombre" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpproduct->name;  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                <input data-parsley-id="2967" name="codigo" id="codigo" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpproduct->code;  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                <input data-parsley-id="2967" name="description_first" id="description_first" class="form-control input-lg" data-parsley-group="wizard-step-1" value="<?php echo $tmpproduct->description_first;  ?>" required type="text"><ul id="parsley-id-2967" class="parsley-errors-list"></ul>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
