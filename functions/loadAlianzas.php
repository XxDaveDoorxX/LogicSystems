...
$total_registros = current($tmpalianza->contar_total_registros());
...
$alianzas = $tmpalianza->listar2(" WHERE id ORDER BY create_at DESC LIMIT ".$registro_actual.", ".$registros_x_pagina);
